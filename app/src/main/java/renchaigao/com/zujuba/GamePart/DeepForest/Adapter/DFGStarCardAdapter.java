...
public class DFGStarCardAdapter extends RecyclerView.Adapter<DFGStarCardAdapter.ViewHolder> {
    ...
    @Override
    public DFGStarCardAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return null;
    }

    @Override
    public void onBindViewHolder(DFGStarCardAdapter.ViewHolder holder, int position) {
